...
setLng(lngParam)
  ...
  const fileUploadHandler = async (event) => {
    ...
    try {
      ...
      const URL = "https://3431-35-196-131-226.ngrok-free.app/predict";
...
let newid
  ...
  const newLink = `http://localhost:3000/disease/${newid}?lng=${lng}`;
  setLink(newLink);
}, [id, lng]);
  return (
    <div className="box">
        ...
        {prediction && (
          <div>
            <p>
              ...
              <br /> {t("Predicted Confidence")} : {Confidence} {id}
              <br />
